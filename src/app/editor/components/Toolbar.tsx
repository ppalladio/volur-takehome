...
import { Button, Menubar, MenubarContent, MenubarItem, MenubarMenu, MenubarShortcut, MenubarTrigger } from '@/components';
import { useEditor } from '@/hooks';

import { CheckSquare, FileText, Plus, Redo2, Undo2 } from 'lucide-react';
